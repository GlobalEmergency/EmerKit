...
class _AgeGroup {
  ...
  final String spo2;
  final String temp;
  const _AgeGroup(this.name, this.icon, this.fc, this.fr, this.tas, this.tad, this.spo2, this.temp);
}

const _groups = [
  _AgeGroup('Adulto', Icons.person, '60-100', '12-20', '100-140', '60-90', '>94%', '36-37.5°C'),
  _AgeGroup('Adolescente (12-18)', Icons.person, '60-100', '12-20', '100-130', '60-85', '>94%', '36-37.5°C'),
  _AgeGroup('Escolar (5-12 años)', Icons.school, '70-110', '15-25', '90-110', '55-75', '>94%', '36-37.5°C'),
  _AgeGroup('Niño (1-5 años)', Icons.boy, '80-130', '20-30', '80-100', '50-70', '>94%', '36-37.5°C'),
  _AgeGroup('Lactante (1-12 meses)', Icons.child_care, '100-150', '25-50', '70-90', '40-60', '>94%', '36.5-37.5°C'),
  _AgeGroup('Neonato (0-28 días)', Icons.child_friendly, '120-160', '30-60', '60-80', '30-50', '>94%', '36.5-37.5°C'),
];
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        _buildVitalChip('TAD', g.tad, 'mmHg', Colors.orange.shade700),
